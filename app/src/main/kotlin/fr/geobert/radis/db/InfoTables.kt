...
public object InfoTables {
    ...
    val ADD_NORMALIZED_MODE: String = "ALTER TABLE $DATABASE_MODES_TABLE ADD COLUMN $KEY_MODE_NORMALIZED_NAME text not null DEFAULT ''"

    val ADD_NORMALIZED_TAG: String = "ALTER TABLE $DATABASE_TAGS_TABLE ADD COLUMN $KEY_TAG_NORMALIZED_NAME text not null DEFAULT ''"

    val ADD_NORMALIZED_THIRD_PARTY: String = "ALTER TABLE $DATABASE_THIRD_PARTIES_TABLE ADD COLUMN $KEY_THIRD_PARTY_NORMALIZED_NAME text not null DEFAULT ''"

    val ADD_WEIGHT_COL: String = "ALTER TABLE %s ADD COLUMN $KEY_WEIGHT integer DEFAULT 0"
