...
- les propositions pour l'ajout rapide sont affichés en ordre inverse d'utilisation pour avoir les plus utilisés au plus proche du champs texte (désactivable dans les options)
